      		...
      		<form method="POST">
				<input type="hidden" name="csrf" id="csrf" value="<?php echo $_SESSION['csrf'];?>">
      			<div class="modal-body">
				  	...
				  	<div class="form-group pass">
				    	<label for="pass">Ponovljena Lozinka</label>
				    	<input type="password" class="form-control" name="repeat_pass" id="repeat_pass" placeholder="Ponovljena Lozinka">
				  	</div>
      		</form>
      			<div class="modal-footer">
        			<button type="button" class="btn btn-default" data-dismiss="modal">Zatvori</button>
        			<button type="button" class="btn btn-primary" id="register">Registriraj se</button>
      			</div>
    	</div>
  	</div>
</div>
